    ...
    return (
      <div className="landing-page">
        <div className="landing-hero-image">
          ...
          <div class="tagline">
            I am an Engineering Leader, Software Developer, and Researcher who loves new technology, science, and
            Formula 1.
          </div>
        </div>
        ...
        <section className="landing-section content-padding">
          ...
          <hr />
          <p>
            I am an Engineering Leader and Software Developer with a PhD in Physics, a passion for innovation, and a
            mild obsession with data. I have a history of building and scaling engineering teams and I’m at my best when
            ...
            After research, I spent 3 years as a technical recruiter, growing tech teams with some of the most
            innovative companies in the world. This inspired me to dive deeper into understanding technology and
            software development from a business context and now I am putting all these pieces together. <br /> <br />
            ...
            Python, improving my knowledge and skills in the area of machine learning and AI (a long term passion of
            mine - I refer you back to my mild obsession with all things data related), and reading and writing blogs
            relating to tech, leadership, and recruitment. You can read some of them on{" "}
